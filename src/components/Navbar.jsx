...
const Navbar = () => {
  return (
    <div className="container m-auto bg-gradient-to-r from-slate-100 to-red-600 flex justify-around gap-[40vw] h-16 md:text-lg items-center fixed md:w-full z-20 shadow-md">
